...
import {Route, useNavigate, Routes, Link, useLocation} from "react-router-dom";
                  ...
                  <ul className="mt-4 nav nav-pills nav-fill">
                      <li className="nav-item">
                          <Link to="/profile/mytuits"
                                className={`nav-link ${lastPath === "mytuits" ? 'active':''}`}>
                              Tuits</Link>
                      </li>
                      <li className="nav-item">
                          <Link to="/profile/tuits-and-replies"
                                className={`nav-link ${lastPath === "tuits-and-replies" ? 'active':''}`}>
                              Tuits & replies</Link>
                      </li>
                      <li className="nav-item">
                          <Link to="/profile/media"
                                className={`nav-link ${lastPath === "media" ? 'active':''}`}>
                              Media</Link>
                      </li>
                      <li className="nav-item">
                          <Link to="/profile/likes"
                                className={`nav-link ${lastPath === "likes" ? 'active':''}`}>
                              Likes</Link>
                      </li>
                      <li className="nav-item">
                          <Link to="/profile/dislikes"
                                className={`nav-link ${lastPath === "dislikes" ? 'active':''}`}>
                              Dislikes</Link>
                      </li>
                  </ul>
              </div>
